...
class PollDo extends Component {
  ...
  myVote = (question) =>{
      return (
        <div>
            <div className='userchip'  onClick={() => this.handleOptionChange()} >
  ...
  noVote = (question) =>{
      return (
      <div>
          <div className='userchipno'  onClick={() => this.handleOptionChange()}>
            ...
            <div className='pollQuestions'>
              <div className='optionOneGroup' >
                <div className='voterGroup'>
                  {optionOne
                  ?  this.myVote(questions[id].optionOne.text)
                  :  this.noVote(questions[id].optionOne.text)
                  }
                </div>
              </div>
              <div className='optionTwoGroup' >
                <div className='voterGroup'>
                {!optionOne
                  ?  this.myVote(questions[id].optionTwo.text)
                  :  this.noVote(questions[id].optionTwo.text)
                  }
                </div>
              </div>
