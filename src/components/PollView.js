          ...
          <div className='pollheader'>
            ...
            <div className='pollQuestions'>
              ...
              <div className='optionOneGroup' >
                <span className='pollinfo'>Would you rather {questions[id].optionOne.text}</span>
                <div className='optionOneBar' >
                  { optionOne !== 0 ?
                    <div className='optionOneCount'
                    style={{
                      width: optionOne + '%',
                    }}>{optionOne}% </div>
                  :
                ...
                <span className='pollct'>{optOne} out of {total} votes</span>
                <div className='voterGroup'>
                  {this.votersChoice(optionOne)}
                  {this.checkMyVote(questions[id].optionOne.votes)}
                </div>
              </div>
              <div className='optionTwoGroup' >
                <span className='pollinfo'>Would you rather {questions[id].optionTwo.text}</span>
                <div className='optionTwoBar' >
                  { optionTwo !== 0 ?
                    <div className='optionTwoCount'
                    style={{
                      width: optionTwo + '%',
                    }}>{optionTwo}% </div>
                  :
                ...
                <span className='pollct'>{optTwo} out of {total} votes</span>
                <div className='voterGroup'>
                  {this.votersChoice(optionTwo)}
                  {this.checkMyVote(questions[id].optionTwo.votes)}
                </div>
              </div>
            </div>
          </div>
